...
namespace HeavyGo_Project_Identity.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedArrivalMinutes = table.Column<double>(type: "float", nullable: true),
                    ProposedPrice = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverOrderRequests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_DriverOrderRequests_AspNetUsers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DriverOrderRequests_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "DriverOrderRequests",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_DriverOrderRequests_OrderId",
                table: "DriverOrderRequests",
                column: "OrderId");
